...
const InfoTooltip: React.FC<InfoTooltipProps> = ({ content }) => {
  return (
    <div className="group relative inline-flex ml-2 items-center">
      ...
      {/* Tooltip Container */}
      <div className="pointer-events-none absolute bottom-full left-1/2 mb-2 hidden w-64 -translate-x-1/2 rounded bg-gray-900 p-3 text-xs text-left whitespace-pre-line text-white opacity-0 shadow-lg transition-opacity group-hover:block group-hover:opacity-100 z-50">
        {content}
        {/* Arrow */}
