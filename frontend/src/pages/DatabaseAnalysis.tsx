    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-3">
          ...
          <Card className="bg-card col-span-2">
              <CardHeader><CardTitle className="text-base font-semibold">Time Spent vs Load Trend</CardTitle></CardHeader>
              <CardContent>
           ...
           {/* Efficiency Donut */}
           <Card className="bg-card">
              <CardHeader><CardTitle className="text-base font-semibold">Efficiency Distribution</CardTitle></CardHeader>
              <CardContent>
       ...
       {/* CPU Chart */}
       <Card className="bg-card">
          <CardHeader><CardTitle className="text-base font-semibold">CPU Resource Usage</CardTitle></CardHeader>
          <CardContent>
      ...
      {/* Top 5 Queries Table */}
      <Card className="bg-card">
          <CardHeader><CardTitle className="text-base font-semibold">Top 5 Heavy Queries (by Weight)</CardTitle></CardHeader>
          <CardContent>
      ...
      <Card className="bg-card">
          <CardHeader><CardTitle className="text-base font-semibold">Top 10 Query Weight Distribution</CardTitle></CardHeader>
          <CardContent>
              <div className="h-[300px]">
